module github.com/shortlink-org/go-sdk/db
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/go.mongodb.org/mongo-driver/v2/mongo/otelmongo v0.0.0-20260904203645-03e6da684d93
